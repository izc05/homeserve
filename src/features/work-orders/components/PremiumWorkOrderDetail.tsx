...
export type PremiumWorkOrderDetailProps = {
  ...
  operationalPanels?: {
    ...
    technical?: ReactNode;
    evidence?: ReactNode;
    checklistEvidence?: ReactNode;
    installationGallery?: ReactNode;
    review?: ReactNode;
    cancel?: ReactNode;
  };
};
