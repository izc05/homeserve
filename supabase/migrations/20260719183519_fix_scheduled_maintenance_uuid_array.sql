-- Hace explícito el tipo del acumulador de identificadores generados.
...
revoke all on function public.generate_due_scheduled_maintenances(uuid, integer) from public, anon;
